...
- [Implement Multilingual Content with Directus and Svelte Kit | Directus Docs](https://directus.io/docs/tutorials/getting-started/implement-multilingual-content-with-directus-and-svelte-kit)

- [build a multi language blog using directus cms | Perplexity.ai](https://www.perplexity.ai/search/build-a-multi-language-blog-us-NPU1gqpLSmWsxRLZpBx4AA)
